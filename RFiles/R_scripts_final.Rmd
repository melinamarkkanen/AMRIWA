...
resfinder_PHY_subset <- subset_taxa(resfinder_PHY_subset, Cluster_name == "nimE_1_clust")
resfinder_PHY_subset <- subset_taxa(resfinder_PHY_subset, taxa_sums(resfinder_PHY_subset) != 0)

resfinder_PHY_subset <- subset_taxa(resfinder_PHY_subset, Cluster_name == "nimA_1")
resfinder_PHY_subset <- subset_taxa(resfinder_PHY_subset, taxa_sums(resfinder_PHY_subset) != 0)
