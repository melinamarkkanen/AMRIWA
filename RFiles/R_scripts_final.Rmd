...
arg <- p_ord + 
  ...
  stat_ellipse(level = 0.90, linetype = 1) +
    ...
    theme(plot.title = element_text(size = 24, family = "Times", face = "bold"),
...
ordinations <- plot_grid(arg, mp_mge, ncol = 2, rel_widths = c(1.25, 0.75), rel_heights = c(1, 1))
ordinations
...
mp_mge <- plot_grid(mp, mge, nrow = 2)
ordinations <- plot_grid(arg, mp_mge, ncol = 2, scale = c(1.1, .70, 70))
ordinations
