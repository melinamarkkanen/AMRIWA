...
# Add in capital and important cities & countru name
gps_Ben_labels <- data.frame(country = c("Benin", "Benin", "Benin"),
                               lat = c("6.4990718", "6.3676953", "7.165446"),
                               long = c("2.6253361", "2.4252507", "1.9828804"))
rownames(gps_Ben_labels) <- c("Porto Novo", "Cotonou", "Abomey")

gps_data <- rbind(gps_Ben, gps_Ben_labels)
gps_data$Label <- c("nd", "nd", "nd", "nd", "nd", "Porto Novo", "Cotonou", "Abomey")
