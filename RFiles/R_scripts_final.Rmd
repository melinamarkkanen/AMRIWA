...
arg <- p_ord + 
  ...
  stat_ellipse(level = 0.90, linetype = 1) +
    geom_text_repel(mapping = aes(label = hospital), size = 7, family = "Times", hjust = 1.2) +
    theme_minimal() + labs(title = "Hospital wastewaters in Benin, \nBurkina Faso and Finland
                           
                           ", subtitle = "Resistome (ResFinder)") +
    theme(plot.subtitle = element_text(size = 24, family = "Times", face = "bold"),
          plot.title = element_text(size = 26, family = "Times"),
...
mp_mge <- plot_grid(mp, mge, nrow = 2)
ordinations <- plot_grid(arg, mp_mge, ncol = 2, scale = c(1.15, .75, 75))
ordinations

plot_grid(ordinations, ncol = 1)
...
plot_grid(ordinations, ncol = 1) + theme(plot.margin = unit(c(1,0.5,0.5,0.5), "cm"))
