...
# Less famous carbs
```{r}
#carb: sim, ind, spm, fri, imi, sme, bkc, sfc, nmcA, imis, penA, blaEBR-1_1, cgb, bic, dim
resfinder_PHY_Cluster <- subset_taxa(resfinder_PHY_stat, Cluster_name == "blaSIM-1_1" | Cluster_name == "blaIND-1_1_clust" |
                                           ...
                                           Cluster_name == "blaBKC-1_1" | Cluster_name == "blaSFC-1_1" | 
