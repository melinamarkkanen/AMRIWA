...
#ggplot(data = df_Benin, aes(x = long, y = lat, fill = hospital)) +
#  geom_text(data=df_Benin, aes(label = hospital, x = long, y = lat), hjust = 1.5, vjust = 1.75, size = 5, family = "Times") +
#  geom_point(shape = 19, size = 4, colour = "#B2182B") +
#  coord_equal() +
...
#  ggtitle("Benin") + 
#  scale_y_continuous(minor_breaks = seq(2.30e+14, 2.50e+14, 1.0e+12), limits = c(2.30e+14, 2.50e+14)) +
#  scale_x_continuous(minor_breaks = seq(6.30e+14, 6.50e+14, 1.0e+12), limits = c(6.30e+14, 6.50e+14))
