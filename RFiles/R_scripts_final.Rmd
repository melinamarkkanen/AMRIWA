...
# Add in capital and important cities
...
map <- ggplot(data = world) +
  ...
  theme(axis.text = element_text(family = "Times", size = 12),
        plot.title = element_text(family = "Times", face = "bold", size = 24),
...
# Add in capital and important cities
gps_BF_labels <- data.frame(country = c("Burkina Faso", "Burkina Faso", "Burkina Faso"),
                               lat = c("12.3681873", "11.1757783", "10.642703"),
                               long = c("-1.5270944", "-4.2957591", "-4.752639"))
rownames(gps_BF_labels) <- c("Ouagadougou", "Bobo Dioulasso", "Banfora")

gps_data <- rbind(gps_BF, gps_BF_labels)
gps_data$Label <- c("nd", "nd", "nd", "nd", "Ouagadougou", "Bobo Dioulasso", "Banfora")
gps_data$lat <- as.numeric(gps_data$lat)
gps_data$long <- as.numeric(gps_data$long)
