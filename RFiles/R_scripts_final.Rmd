...
MyVar <- c("SSU_counts", "ARG_SUM", "intI1_SUM", "M_Seqs_trimmed")
Mydotplot(df[,MyVar])

# Collinearity
MySel <- c("ARG_SUM", "intI1_SUM", "country", "hospital", "hospital_section", 
           "SSU_counts", "rpoB_counts", "A260_280", "DNA_ng_µl", "M_Seqs_trimmed")
Mypairs(df[,MySel])
...
# There seems to be more variation in the SSU_counts between HWWs collected from different countries.
# As the SSU and rpoB counts seemed to be collinear, we should pick only one of them, let's choose SSU.
...
# Due to the low quality of this data (e.g. only few observations in Finland), 
# this interaction should not be included in the model.
...
df<-data.frame(ARG_SUM=sample_sums(resfinder_PHY_stat),
               ...
               long=as.factor(sample_data(resfinder_PHY_stat)$long),
               lat=as.factor(sample_data(resfinder_PHY_stat)$lat),
               A260_380=as.numeric(sample_data(resfinder_PHY_stat)$A260_380),
               DNA_ng_µl=as.numeric(sample_data(resfinder_PHY_stat)$DNA_ng_µl),
               M_Seqs_trimmed=as.numeric(sample_data(resfinder_PHY_stat)$M_Seqs_trimmed))
...
selected <- subset_taxa(heat_resfinder_PHY_Clusters, 
                        ...
                        Cluster_name == "blaKPC-34_1_clust" | Cluster_name == "catB3_3_clust" |     
                        Cluster_name == "blaGES-1_1_clust" | Cluster_name == "blaVEB-1_1_clust" |
                        Cluster_name == "cfxA_1_clust" | Cluster_name == "blaCMY-150_3_clust" |       
...
rownames(heat.df) <- c("aadA2_1_clust__(aadA)", "aph(6)-Id_1_clust__(aph(6)-Id)", "blaNDM-18_1_clust__(blaNDM-1)", 
                     ...
                     "blaIMP-58_1_clust__(blaIMP)", "blaCMY-150_3_clust__(blaCMY-2)", "blaCTX-M-211_1_clust__(Group I blaCTX-M)",
                     ...
                     "catB3_3_clust__(catB3)", "cmlA1_1_clust__(cmlA)", "qnrA1_1_clust__(qnrA)", 
...
resfinder_PHY_Cluster_3 <- subset_taxa(resfinder_PHY_stat, Gene == "blaGES-2_1_AF326355" | Gene == "blaGES-4_1_AB116723" | Gene == "blaGES-5_1_DQ236171" 
...
rfc_plot <- rfc +
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(size = 12, family = "Times", angle = 90, hjust = 1, vjust = 1),
        axis.text.y = element_text(size = 28, family = "Times", face = "bold", angle = 0),
        axis.title.y = element_text(size = 30, family = "Times"),
        axis.title.x = element_blank(),
        legend.text = element_text(size = 28, family = "Times", face = "italic"),
...
resfinder_PHY_Cluster_3 <- subset_taxa(resfinder_PHY, Gene == "blaGES-2_1_AF326355" | Gene == "blaGES-4_1_AB116723" | Gene == "blaGES-5_1_DQ236171" 
                                       | Gene == "blaGES-6_1_AY494718" | Gene == "blaGES-14_1_GU207844" | Gene == "blaGES-16_1_HM173356" 
                                       | Gene == "blaGES-18_1_JQ028729" | Gene == "blaGES-20_1_JN596280" # carbapenemase blaGES
...
# ESBLs
```{r}
resfinder_PHY_Cluster <- subset_taxa(resfinder_PHY_stat, Cluster_name == "blaCTX-M-211_1_clust" | Cluster_name == "blaCTX-M-4_1_clust" |
                                           Cluster_name == "blaCTX-M-8_1_clust" | Cluster_name == "blaCTX-M-110_1_clust" |
                                           Cluster_name == "blaCTX-M-25_1_clust" | Cluster_name == "blaCTX-M-64_1_clust" |
                                           Cluster_name == "blaCTX-M-74_1_clust" | Cluster_name == "blaCTX-M-151_1" |
                                           Cluster_name == "blaPER-1_1_clust" | Cluster_name == "blaPER-2_1" |
                                           Cluster_name == "blaPER-6_1" | Cluster_name == "blaRAHN-1_1_clust" |
                                           Cluster_name == "blaRAHN-1_1_clust" | Cluster_name == "blaRAHN-2_3" | 
                                           Cluster_name == "blaTEM-1A_1_clust" | Cluster_name == "blaVEB-1_1_clust" | 
                                           Cluster_name == "blaBES-1_1" | Cluster_name == "blaTLA-1_1" | 
                                           Cluster_name == "cfxA_1_clust" | Cluster_name == "cfxA6_1" | 
                                           Cluster_name == "blaSHV-100_1_clust" | Cluster_name == "blaLUT-1_1" |
                                           Cluster_name == "blaCME-1_1" | Cluster_name == "blaDES-1_1" | 
                                           Cluster_name == "blaACI-1_1" | Cluster_name == "blaPME-1_1" | 
                                           Cluster_name == "blaERP-1_1" | Cluster_name == "blaFAR-1_1")
...
# Less famous carbs
```{r}
resfinder_PHY_Cluster <- subset_taxa(resfinder_PHY_stat, 
                                           #Cluster_name == "blaSIM-1_1" | Cluster_name == "blaIND-1_1_clust" |
                                           #Cluster_name == "blaIND-2_3_clust" | Cluster_name == "blaIND-3_1_clust" |
                                           #Cluster_name == "blaIND-4_1" | Cluster_name == "blaIND-5_1" |
                                           #Cluster_name == "blaIND-6_1" | Cluster_name == "blaIND-8_1_clust" |
                                           #Cluster_name == "blaIND-9_1" | Cluster_name == "blaSPM-1_1" |
                                           #Cluster_name == "blaFRI-1_1_clust" | Cluster_name == "blaFRI-5_1" |
                                           #Cluster_name == "imiS_1_clust" | Cluster_name == "blaSME-1_1_clust" | 
                                           Cluster_name == "blaBKC-1_1"
                                           #Cluster_name == "blaSFC-1_1" | 
                                           #Cluster_name == "blaNMC-A_1_clust" | Cluster_name == "penA_1" | 
                                           #Cluster_name == "blaEBR-1_1" | Cluster_name == "blaCGB-1_1" | 
                                           #Cluster_name == "blaBIC-1_1" | Cluster_name == "blaDIM-1_1"
                                     )
...
# Check with CARD
CARD_PHY_Cluster <- subset_taxa(CARD_PHY_stat, Gene == "BKC-1")
CARD_PHY_Cluster <- subset_samples(CARD_PHY_Cluster, sample_sums(CARD_PHY_Cluster) != 0)
...
card_plot
```
# Disinfection resistance genes
```{r}
MGE_PHY_qac_plot <- subset_samples(MGE_PHY_qac, sample_sums(MGE_PHY_qac) != 0)

cols <- get_palette(c("#332288", "#117733", "#44AA99", "#88CCEE", "#DDCC77", "#CC6677", "#AA4499", "#882255", "#5F5E98", "#331225"), 43)
rfc <- plot_bar(MGE_PHY_qac_plot, fill = "Element") 
rfc_plot <- rfc +
  geom_bar(stat="identity", color = NA, size = 0) +
  scale_fill_manual(values = cols) +
  labs(y = expression(atop(bold("ARGs to 16s rRNA"), atop("ResFinder")))) +
...
rfc <- plot_bar(resfinder_PHY_stat, fill = "Class") 
rfc_plot <- rfc +
  geom_bar(stat="identity", color = NA, size = 0) +
  scale_fill_manual(values = cols) +
  labs(y = expression(atop(bold("ARGs to 16s rRNA"), atop("ResFinder")))) +
...
ggsave(filename = "resfinder_all_by_class.png",
       width = 16, height = 13, dpi = 300, units = "in", device='png', scale = 1)
```
# Taxonomy
```{r}
...
pattern_Ben <- data.frame(dplyr::filter(tax,
                                  grepl("aph\\(6\\)-Id_1_M28829|aph\\(6\\)-Id_4_CP000971|aph\\(3''\\)-Ib_3_AF321550|ant\\(3''\\)-Ia_1_X02340|aph\\(3''\\)-Ib_3_AF024602|aph\\(3''\\)-Ib_5_AF321551|aph\\(6\\)-Id_3_AF024602|blaOXA-347_1_ACWG01000053|blaOXA-129_1_FJWZ01000025|blaOXA-256_1_HE616889|cmlA1_1_M64556|sul1_5_EU780013|tet\\(A\\)_6_AF534183|tet\\(C\\)_3_AY046276|tet\\(C\\)_3_AF055345", 
                                        Gene)))
...
# shorten gene names
#rownames(arg_data) <- gsub(pattern = "_[A-Z].*", replacement = "", rownames(arg_data))
rownames(arg_data) = c("aph(6)-Id_1", "aph(6)-Id_4", "aph(3'')-Ib_3", "ant(3'')-Ia_1", "aph(3'')-Ib_3", "aph(3'')-Ib_5", "aph(6)-Id_3", "blaOXA-347", "blaOXA-129", "blaOXA-256", "cmlA1", "sul1", "tet(A)_6", "tet(C)_3", "tet(C)_3")
...
pattern_BF <- data.frame(dplyr::filter(tax,
                                  grepl("aph\\(6\\)-Id_1_M28829|ant\\(3''\\)-Ia_1_X02340|aph\\(3''\\)-Ib_3_AF024602|aph\\(3''\\)-Ib_5_AF321551|blaOXA-101_1_AM412777|blaCMY-4_1_LNHZ01000079|msr\\(E\\)_1_FR751518|nimA_1_X71444|cmlA1_1_M64556|cmlA1_3_AB212941|qnrS2_1_DQ485530|sul1_5_EU780013|tet\\(39\\)_1_KT346360|tet\\(C\\)_3_AY046276|tet\\(C\\)_3_AF055345", 
                                        Gene)))
...
# shorten gene names
#rownames(arg_data) <- gsub(pattern = "_[A-Z].*", replacement = "", rownames(arg_data))
rownames(arg_data) = c("aph(6)-Id_1", "ant(3'')-Ia_1", "aph(3'')-Ib_3", "aph(3'')-Ib_5", "blaOXA-101", "blaCMY-4", "msr(E)", "nimA", "cmlA1_1", "cmlA1_3", "qnrS2", "sul1", "tet(39)", "tet(C)_3", "tet(C)_3")
...
pattern_Fin <- data.frame(dplyr::filter(tax,
                                  grepl("aac\\(6'\\)-Ib-Hangzhou_1_FJ503047|aph\\(6\\)-Id_1_M28829|aac\\(6'\\)-IIa_1_M29695|ant\\(3''\\)-Ia_1_X02340|aadA1b_1_M95287|blaOXA-427_1_KX827604|blaMOX-6_1_GQ152601|cfxA6_1_GQ342996|blaOXA-296_1_APOH01000009|erm\\(B\\)_18_X66468|msr\\(E\\)_1_FR751518|mph\\(E\\)_1_DQ839391|mph\\(E\\)_3_JF769133|tet\\(39\\)_1_KT346360|tet\\(Q\\)_1_L33696", 
                                        Gene)))
...
# shorten gene names
#rownames(arg_data) <- gsub(pattern = "_[A-Z].*", replacement = "", rownames(arg_data))
rownames(arg_data) = c("aac(6')-Ib-Hangzhou", "aph(6)-Id_1", "aac(6')-IIa_1", "ant(3'')-Ia_1", "aadA1b", "blaOXA-427", "blaMOX-6", "cfxA6", "blaOXA-296", "erm(B)", "msr(E)", "mph(E)_1", "mph(E)_3", "tet(39)", "tet(Q)")
...
pattern_prist <- data.frame(dplyr::filter(tax,
                                  grepl("aadA2_1_NC_010870|aph\\(6\\)-Id_1_M28829|ant\\(2''\\)-Ia_6_AJ871915|ant\\(2''\\)-Ia_9_HM367610|ant\\(2''\\)-Ia_10_HM367617|ant\\(3''\\)-Ia_1_X02340|blaOXA-129_1_FJWZ01000025|blaOXA-256_1_HE616889|blaADC-25_1_EF016355|blaPAU-1_1_MH053445|msr\\(E\\)_1_FR751518|mph\\(E\\)_1_DQ839391|mph\\(E\\)_3_JF769133|sul1_5_EU780013|tet\\(39\\)_1_KT346360", 
                                        Gene)))
