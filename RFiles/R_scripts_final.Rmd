...
metadata$A260_380 <- as.numeric(gsub(",", ".", gsub("\\.", "", metadata$A260_380)))
...
df<-data.frame(ARG_SUM=sample_sums(resfinder_PHY_stat),
               ...
               A260_380=as.numeric(sample_data(resfinder_PHY_stat)$A260_280),
...
# Collinearity
MySel <- c("ARG_SUM", "intI1_SUM", "country", "hospital", "hospital_section", "SSU_counts", "rpoB_counts", "A260_280", "DNA_ng_µl", "M_Seqs_trimmed")
Mypairs(df[,MySel])
