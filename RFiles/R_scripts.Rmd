...
```
# Taxonomic composition by Metaxa2 using microbiome
```{r}
# Load data
metaxa.com <- metaxa_PHY_ww
taxic <- as.data.frame(metaxa.com@tax_table) 
...
tax_table(metaxa.com) <- new.tax 

# Class level
metaxa_top6genus <- aggregate_top_taxa(metaxa.com, top = 6, "Class")
