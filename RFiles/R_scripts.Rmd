...
# The results are almost identical to the ones from Metaxa2 analysis: The explanatory variable "country" explains some of the difference in the grouping of taxonomy in the comparison between of Benin and Finland.
```
# ResFinder
## Load data
```{r}
