...
metaxa_PHY = subset_samples(metaxa_PHY, name != "BH02_S77" & name != "BH27_S92" & name != "BH30_S94")
...
# In Benin the ARG profile is explained by  26.3 % by the location. Whereas in Burkina Faso the same percentage is  24.2 %. In Finland the grouping by location is not significant.
```
...
# Feces samples (BH20_S88, BH22_S89, BH24_S90, BH25_S91)
metaphlan_PHY = subset_samples(metaphlan_PHY, name!="BH20_S88" & name!="BH22_S89" & name!="BH24_S90" & name!="BH25_S91")

# Suspicious samples (very high ARG level)
metaphlan_PHY = subset_samples(metaphlan_PHY, name != "BH02_S77" & name != "BH27_S92" & name != "BH30_S94")
...
# In Benin the ARG profile is explained by  29.7 % by the location. Whereas in Burkina Faso the same percentage is  22.2 %. In Finland the grouping by location is not significant.
```
...
metaphlan_top5class.rel <- microbiome::transform(metaphlan_top5class, "compositional")

metaphlan_top5class.p15 <- plot_composition(metaphlan_top6class.rel, group_by = "country") + 
  theme(legend.position = "bottom") + theme_classic() +
  theme(axis.text.x = element_text(angle = 90, size = 8), axis.title = element_blank()) +
    ggtitle("Relative abundance of top 6 classes, Metaphlan3")

metaphlan_top5class.p15 + 
    scale_fill_manual(values = c("#1B9E77","#E6AB02","#7570B3","#E7298A","#66A61E","#FFFFFF"))
```
...
```
# Top 12 ARG genes, relative abundance
```{r}
